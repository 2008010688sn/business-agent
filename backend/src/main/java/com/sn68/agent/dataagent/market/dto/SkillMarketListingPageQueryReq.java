...
@Schema(description = "能力市场条目分页查询请求")
public class SkillMarketListingPageQueryReq extends PageRequest {

	@Schema(description = "条目名称，模糊匹配")
	private String listingName;

	@Schema(description = "分类")
	private String category;

	@Schema(description = "发布者名称，模糊匹配")
