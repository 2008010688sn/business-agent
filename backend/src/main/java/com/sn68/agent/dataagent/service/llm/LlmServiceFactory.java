 ...
 */
package com.sn68.agent.dataagent.service.llm;

import com.sn68.agent.dataagent.properties.DataAgentProperties;
import com.sn68.agent.dataagent.service.aimodelconfig.AiModelRegistry;
import com.sn68.agent.dataagent.service.llm.impls.BlockLlmService;
import com.sn68.agent.dataagent.service.llm.impls.StreamLlmService;
import lombok.AllArgsConstructor;
import org.springframework.beans.factory.FactoryBean;
import org.springframework.stereotype.Component;

/**
 * LlmService 工厂 Bean：按调用方式装配阻塞/流式 LLM 服务实现。
 */
@Component
@AllArgsConstructor
