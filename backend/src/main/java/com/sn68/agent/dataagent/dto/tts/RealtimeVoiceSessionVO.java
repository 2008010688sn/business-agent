...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "实时语音会话展示对象")
public class RealtimeVoiceSessionVO {
	...
	@Schema(description = "当前对话轮次ID")
	private String currentTurnId;

	@Schema(description = "最后消息序号")
	...
	@Schema(description = "WebSocket令牌过期时间")
