 ...
 */
package com.sn68.agent.dataagent.service.hybrid.retrieval;
...
public abstract class AbstractHybridRetrievalStrategy implements HybridRetrievalStrategy {
	...
	@Override
	public List<Document> retrieve(HybridSearchReq request) {
		...
		try {
			...
			throw new IllegalStateException("Search operation interrupted", e);
		}
		catch (ExecutionException e) {
			throw new IllegalStateException("Error during parallel search execution", e);
		}

	}

	public abstract List<Document> getDocumentsByKeywords(HybridSearchReq request);
