 ...
 */
package com.sn68.agent.dataagent.service.hybrid.retrieval.impl;
...
import com.sn68.agent.dataagent.service.hybrid.retrieval.AbstractHybridRetrievalStrategy;
...
/**
 * 基于 Elasticsearch 的混合检索策略：组合全文与向量检索结果。
 */
@Setter
@Slf4j
public class ElasticsearchHybridRetrievalStrategy extends AbstractHybridRetrievalStrategy {
	...
	@Override
	public List<Document> getDocumentsByKeywords(HybridSearchReq request) {
		...
		if (nativeClient.isEmpty())
			throw new IllegalStateException("ElasticsearchClient is not available.");
