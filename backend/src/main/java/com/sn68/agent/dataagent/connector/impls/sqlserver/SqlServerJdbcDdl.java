 ...
 */
package com.sn68.agent.dataagent.connector.impls.sqlserver;
...
/**
 * SQL Server 方言的库表结构（DDL）读取实现。方言差异点：库列表读 sys.databases（跳过 database_id&lt;=4
 * 的系统库），表/列注释取 sys.extended_properties（MS_Description），列采样与整表扫描使用
 * TOP 而非 LIMIT 语法。
 *
 * @author zihen
