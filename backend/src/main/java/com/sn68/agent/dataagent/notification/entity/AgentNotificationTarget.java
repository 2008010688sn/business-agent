...
@TableName("agent_notification_target")
@Schema(description = "Agent通知目标实体")
public class AgentNotificationTarget extends SuperEntity<Long> {
