...
/**
 * Agent任务定义修改请求。字段为空表示不修改；
 * 传入 paramsSnapshot/promptSnapshot 任意一项即生成新的不可变任务版本。
 */
@Data
@Schema(description = "Agent任务定义修改请求")
public class AgentTaskDefinitionModifyReq {
	...
	@Schema(description = "默认自治级别（AUTONOMOUS/ASSISTED；高风险写任务强制 ASSISTED）")
	...
	@Schema(description = "任务参数快照（传入则生成新版本）")
	private Map<String, Object> paramsSnapshot;

	@Schema(description = "提示词快照（传入则生成新版本）")
