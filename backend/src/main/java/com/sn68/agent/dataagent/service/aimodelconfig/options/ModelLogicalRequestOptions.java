...
/**
 * 归并完成的逻辑请求选项：resolve 流程的中间产物，交由方言适配器输出 provider 参数。
 */
record ModelLogicalRequestOptions(ModelEndpointDialect endpointDialect, ModelReasoningProtocol reasoningProtocol,
		ModelReasoningMode reasoningMode, ModelReasoningLevel reasoningLevel, Long reasoningBudgetTokens,
		Integer maxOutputTokens, ModelTokenLimitMode tokenLimitMode, ModelTokenAccounting tokenAccounting, Double temperature,
