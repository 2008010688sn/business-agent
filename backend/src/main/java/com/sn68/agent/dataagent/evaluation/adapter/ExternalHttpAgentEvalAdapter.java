...
/**
 * 外部 HTTP Agent 评估适配器禁用态实现。
 */
@Component
public class ExternalHttpAgentEvalAdapter implements AgentEvalAdapter {

	public static final String ADAPTER_CODE = "EXTERNAL_HTTP";

	public static final String SUBJECT_TYPE = "EXTERNAL_HTTP_AGENT";
