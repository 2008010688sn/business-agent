...
/**
 * AgentPresetQuestion服务契约。
 */
public interface AgentPresetQuestionService extends SuperService<AgentPresetQuestion> {
	...
	/**
	 * 处理AgentPresetQuestion。
	 */
	void batchSaveRequests(Long agentId, List<SavePresetQuestionReq> requests);
