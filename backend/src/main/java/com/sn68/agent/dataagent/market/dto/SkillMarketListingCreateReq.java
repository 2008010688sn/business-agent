...
/**
 * 能力市场条目创建请求（发布者侧，创建后为 DRAFT 草稿）。
 */
@Builder
@Schema(description = "能力市场条目创建请求")
public record SkillMarketListingCreateReq(
		...
		@Schema(description = "风险等级，缺省 LOW") MarketRiskLevel riskLevel,
