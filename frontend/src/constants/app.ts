...
export const themeStyleRecord: Record<UnionKey.ThemeStyle, App.I18n.I18nKey> = {
  classic: 'theme.themeStyle.classic',
  minimal: 'theme.themeStyle.minimal',
  enterprise: 'theme.themeStyle.enterprise'
};

export const themeStyleOptions = transformRecordToOption(themeStyleRecord);
