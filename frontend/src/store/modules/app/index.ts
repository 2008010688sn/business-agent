...
import { getInitialLocale } from '@/locales/url-lang';
...
export const useAppStore = defineStore(SetupStoreId.App, () => {
  ...
  const locale = ref<App.I18n.LangType>(getInitialLocale(localStg.get('lang')));
  ...
  function updateDocumentTitleByLocale() {
    ...
    const tabTitle =
      typeof router.currentRoute.value.query?.tabTitle === 'string' ? router.currentRoute.value.query.tabTitle : '';
