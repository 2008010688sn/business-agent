...
<template>
  <div class="markdown-container">
    <div class="markdown-content" ref="markdown-agent-container"></div>
  </div>
</template>
    ...
    created() {
      ...
      this.renderECharts = debounce(() => {
        ...
        echartsElements.forEach(element => {
          ...
          try {
            const content = chartElement.textContent;
            ...
            if (hasValidJson) {
              ...
              if ((options.xAxis || options.yAxis) && !options.grid) {
                options.grid = { left: 24, right: 24, bottom: 40, containLabel: true };
              }
