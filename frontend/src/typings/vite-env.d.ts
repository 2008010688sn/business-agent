...
declare namespace Env {
  ...
  interface ImportMeta extends ImportMetaEnv {
    ...
    readonly VITE_DATA_AGENT_TOKEN?: string;
    readonly VITE_DATA_AGENT_LOCAL_AUTH_ENABLED?: string;
    ...
    /** Whether DataAgent diagnostic buttons use func permissions; enabled by default, set N to disable */
    readonly VITE_DATA_AGENT_DIAGNOSTIC_BUTTON_PERMISSION_ENABLED?: CommonType.YesOrNo;
