...
import com.sn68.agent.framework.redis.plus.anontation.RedisLimit;
import com.sn68.agent.framework.redis.plus.utils.RedisAopUtils;
...
public class RedisLimitInterceptor {
    ...
    @Pointcut("@annotation(com.sn68.agent.framework.redis.plus.anontation.RedisLimit)")
