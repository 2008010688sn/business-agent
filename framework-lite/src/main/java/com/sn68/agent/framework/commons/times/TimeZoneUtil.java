...
package com.sn68.agent.framework.commons.times;
...
public class TimeZoneUtil {
    ...
    public static TimeZone getHttpTimeZone() {
        return toTimeZone(ThreadLocalHolder.getLocal());
    }

    public static ZoneId getHttpZoneId() {
        return toZoneId(ThreadLocalHolder.getLocal());
    }
