...
package com.sn68.agent.framework.db.properties;
...
public class DatabaseProperties {
     ...
     * 加密字段
     */
    private EncryptField encryptField = new EncryptField();
    ...
    public static class EncryptField {
        public static final String PREFIX = "extend.boot.encrypt";
        private boolean enabled = false;
        private String key = "";
        // 旧密钥(用于密钥轮换过渡期)
        private String oldKey = "";
        private String keyTagPrefix = "encrypt";
    }
    ...
    public static class Audit {
         ...
         */
        private List<String> ignoreGlobalColumns = Lists.newArrayList("deleted", "create_time", "create_by", "created_name", "last_modify_time", "last_modify_by", "last_modified_name");
