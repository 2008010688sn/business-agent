...
package com.sn68.agent.framework.redis.plus.interceptor;

import cn.hutool.core.util.StrUtil;
import com.sn68.agent.framework.commons.exception.CheckedException;
import com.sn68.agent.framework.redis.plus.RedisKeyGenerator;
import com.sn68.agent.framework.redis.plus.anontation.RedisLock;
...
public class RedisLockInterceptor {
    ...
    @SneakyThrows
    @Around("execution(public * *(..)) && @annotation(com.sn68.agent.framework.redis.plus.anontation.RedisLock)")
