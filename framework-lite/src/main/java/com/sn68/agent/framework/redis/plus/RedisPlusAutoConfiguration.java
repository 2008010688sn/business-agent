...
package com.sn68.agent.framework.redis.plus;

import com.alibaba.fastjson2.support.spring6.data.redis.GenericFastJsonRedisSerializer;
import com.sn68.agent.framework.redis.plus.cache.RedisOpsHelper;
import com.sn68.agent.framework.redis.plus.interceptor.RedisLimitInterceptor;
import com.sn68.agent.framework.redis.plus.interceptor.RedisLockInterceptor;
import com.sn68.agent.framework.redis.plus.lock.RedisLockHelper;
import com.sn68.agent.framework.redis.plus.sequence.RedisSequenceHelper;
...
public class RedisPlusAutoConfiguration {
    ...
    @Bean
    public RedisOpsHelper redisOpsHelper(RedisTemplate<String, Object> redisTemplate) {
        return new RedisOpsHelper(redisTemplate);
    }
