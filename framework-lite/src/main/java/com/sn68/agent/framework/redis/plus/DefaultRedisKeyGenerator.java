...
import com.sn68.agent.framework.redis.plus.anontation.RedisParam;
...
public class DefaultRedisKeyGenerator implements RedisKeyGenerator {
    ...
    public String generate(String prefix, String delimiter, ProceedingJoinPoint pjp) {
        ...
        List<String> redisParams = new ArrayList<>();
        ...
        for (Object arg : args) {
            ...
            for (Field field : fields) {
                ...
                if (annotation == null || redisParams.contains(annotation.name())) {
                    continue;
                }
                redisParams.add(annotation.name());
