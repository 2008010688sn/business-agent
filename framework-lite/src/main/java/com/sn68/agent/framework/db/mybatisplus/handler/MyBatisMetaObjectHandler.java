...
package com.sn68.agent.framework.db.mybatisplus.handler;
...
public class MyBatisMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        if (metaObject.hasGetter(Entity.CREATE_USER_NAME)) {
            final Object nickName = Optional.ofNullable(metaObject.getValue(Entity.CREATE_USER_NAME)).orElse(context.nickName());
            this.setFieldValByName(Entity.CREATE_USER_NAME, nickName, metaObject);
        }
    }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        if (metaObject.hasGetter(SuperEntity.UPDATE_USER_NAME)) {
            final Object nickName = Optional.ofNullable(metaObject.getValue(SuperEntity.UPDATE_USER_NAME)).orElse(context.nickName());
            this.setFieldValByName(SuperEntity.UPDATE_USER_NAME, nickName, metaObject);
        }
    }
}
